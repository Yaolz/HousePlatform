...
<form class="form-horizontal" id="register-form" style="margin-top: 20px;">
    ...
    <div class="form-group">
        <label for="inputGender3" class="col-sm-3 control-label">性&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;别：</label>
        <div class="col-sm-7">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-7">
            <input type="text" class="form-control" name="customer.birthday" style="background:rgba(0, 0, 0, 0);" id="birthday" placeholder="请输入客户的生日" readonly>
        </div>
    </div>
    <div class="form-group">
        <label for="identity_id" class="col-sm-3 control-label">身&nbsp;&nbsp;份&nbsp;&nbsp;证&nbsp;&nbsp;&nbsp;&nbsp;号：</label>
        <div class="col-sm-7">
            <input type="text" class="form-control" name="customer.identity_id" id="identity_id" placeholder="请输入客户的身份证号">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-7">
            <input type="text" class="form-control" name="customer.together" id="inputTogether3" placeholder="请输入共同购房人的姓名" >
        </div>
    </div>
    <label class="col-md-3"></label>
    <input type="button"  class="btn btn-primary col-sm-3"  style="margin-top: 10px;margin-bottom: 20px;"  value="取消添加">
    <input type="button" class="btn btn-primary col-sm-3"  style="margin-top: 10px;margin-left: 40px;margin-bottom: 20px;" value="确认添加" onclick="add();">
</form>
</body>
