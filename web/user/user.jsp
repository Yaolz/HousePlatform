...
<div id="wrapper">
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <a><img alt="image" class="img-circle" src="<%=path%>/${sessionScope.user.headicon}" style="width:80px; height:80px" /></a>
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                               <span class="block m-t-xs"><strong class="font-bold"></strong></span>
                                <span class="text-muted text-xs block">欢迎您</span>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="<%=path%>/user/information">基本信息</a>
                        </li>
                        <li>
                            
                            <a class="J_menuItem" href="<%=path%>/user/updatePwd?id=${sessionScope.user.id}">修改密码</a>
                        </li>
                    </ul>
                ...
                <li>
                    <a href="#">
                        ...
                        <span class="nav-label">点赞</span>
                        <span class="fa arrow"></span>
                    </a>
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="<%=path%>/like/good">所有点赞</a>
                        </li>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="<%=path%>/appointment/appointment">所有预约</a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="<%=path%>/comment/comments">所有评价</a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="<%=path%>/history/history">所有历史纪录</a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="<%=path%>/message/message">所有留言</a>
                        </li>
                    </ul>
                </li>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row content-tabs">
            ...
            <a href="<%=path%>/index/remove" class="roll-nav roll-right J_tabExit"><i class="fa fa fa-sign-out"></i> 退出<%--${sessionScope.user.remove}--%></a>
        </div>
        <div class="row J_mainContent" id="content-main">
            <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="<%=path%>/user/information" frameborder="0"></iframe>
        </div>
        <div class="footer">
