        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        ...
                        <ul class="dropdown-menu animated fadeInRight m-t-xs">
                            <li><a onclick="outs();">安全退出</a>
                            </li>
                        </ul>
                    </div>
                    <div class="logo-element">房产营销平台
                    </div>
                </li>
                <li>
                    <a href="#">
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" onclick="outs();">安全退出</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="<%=path %>/agency/agencyAllPage">所有经销商</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="<%=path %>/agency/agencyCheckPage">入驻审核</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="<%=path %>/agency/agencyStatusPage">已冻结经销商</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="<%=path %>/user/userAll">所有用户</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="<%=path %>/buildings/admBuildingsPage">所有楼盘</a>
                        </li>
                    </ul>
                </li>
                <li>
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="<%=path %>/activity/activityInfoPage">平台活动</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="<%=path %>/activity/addActivityPage">活动添加</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="<%=path %>/activity/activitySelfPage">管理员活动</a>
                        </li>
                    </ul>
                </li>
                <li>
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="<%=path %>/article/articleInfoPage ">所有文章</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="<%=path %>/article/addPage">文章添加</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="#">
                        ...
                        <span class="nav-label">文章类别管理</span>
                        <span class="fa arrow"></span>
                    </a>
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="<%=path %>/type/articleType">所有文章类别</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="<%=path %>/type/addType">文章类别添加</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="<%=path %>/ads/adsAllPage">所有广告</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="<%=path %>/ads/adsAddpage">广告添加</a>
                        </li>
                    </ul>
                </li>
        ...
        <div class="row content-tabs">
            ...
            <nav class="page-tabs J_menuTabs">
                <div class="page-tabs-content">
                    <a href="javascript:;" class="active J_menuTab" data-id="<%=path %>/admin/welcome.jsp">首页</a>
                </div>
            </nav>
            ...
            <a onclick="outs();" class="roll-nav roll-right J_tabExit"><i class="fa fa fa-sign-out"></i> 退出</a>
        </div>
        <div class="row J_mainContent" id="content-main">
            <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="<%=path %>/admin/queryInfoPage" frameborder="0" data-id="index_v1.html" seamless></iframe>
        </div>
        <div class="footer">
